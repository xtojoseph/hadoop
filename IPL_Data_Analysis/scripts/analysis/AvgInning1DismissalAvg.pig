...
FILTER_table = FILTER join_table  BY ball::over<=6 and ball::is_wicket == 1 and ball::inning == '1';
...
STORE Avg_Total_Dismissal INTO 'metastore.AvgInning1DismissalAverage' USING org.apache.hive.hcatalog.pig.HCatStorer();