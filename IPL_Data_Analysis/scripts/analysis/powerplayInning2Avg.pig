...
FILTER_table3 = FILTER join_table  BY ball::over<=6 and ball::inning=='2';
...
STORE Avg_Table_Runs INTO 'metastore.Avg_Table_Runs_inning2' USING org.apache.hive.hcatalog.pig.HCatStorer();
