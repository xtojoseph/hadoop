...
public class IsStopWord extends FilterFunc {
	 ...
	 */
	static final List<String> STOP_WORDS = Arrays.asList("able", "about", "above", "abroad", "according", "accordingly",
			"across", "actually", "adj", "after", "afterwards", "again", "against", "ago", "ahead", "ain't", "all",
			"allow", "allows", "almost", "alone", "along", "alongside", "already", "also", "although", "always", "am",
			...
			"caption", "cause", "causes", "certain", "certainly", "changes", "clearly", "c'mon", "co", "co.", "com",
			...
			"doing", "done", "don't", "down", "downwards", "during", "each", "edu", "eg", "eight", "eighty", "either",
